...
function cl_get_profile_posts_details($user_id = false, $limit = 30, $media = false, $post_description = false, $community_id = false, $offset = false)
{
	global $db, $cl, $me;
	...
	$data         = array();
	$sql          = cl_sqltepmlate("apps/show_post_details/sql/fetch_profile_posts", array(
		"t_posts" => T_POSTS,
		"t_pubs"  => T_PUBS,
		"media"   => $media,
		"limit"   => $limit,
